---
name: dokki-file
description: "Upload files or inline document images to Dokki, then manage the created file resources through workspace tools."
argument-hint: "<workspace-id> <file-path-or-description>"
allowed-tools: mcp__dokki__upload_file mcp__dokki__list_resources mcp__dokki__search_workspace mcp__dokki__grep_workspace mcp__dokki__move_resource mcp__dokki__update_resource mcp__dokki__delete_resource
---
...
There is no dedicated `file_read` or `file_update` MCP tool yet. Existing file
resources can be listed, searched, moved, renamed, tagged, shared, or archived
through the workspace/resource tools.
